...
From: https://github.com/benmoran56/esper
"""
...
class World:
    ...
    def _get_components(
        self, *component_types: _Type[_C]
    ) -> _Iterable[_Tuple[int, _List[_C]]]:
    ...
    def try_components(
        self, entity: int, *component_types: _Type[_C]
    ) -> _Optional[_List[_List[_C]]]:
